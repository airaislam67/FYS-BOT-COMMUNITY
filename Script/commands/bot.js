...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Akash") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Rita Akter") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
  ...
  if ((event.body.toLowerCase() == "Sathi") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("Name Dore Dakis na Eta Sojib er bow lage..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Mohammad Sojib ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-Sojib-🌺 আমার বস Akash বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Akash") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("Heaa Boss Kemon Achen..?☺️", threadID);
   };
  mess = "{name}"
